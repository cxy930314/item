				...
				<div class="logo_search">
					...
					<div class="search">
						...
						<div class="search_1_3">
							...
							<a href="#" class="linka5a5">iphone5s</a>
							<a href="#" class="linka5a5">iphone4s</a>
							<a href="#" class="linka5a5">ipad</a>
							<a href="#" class="linka5a5">i9500/S4</a>
							<a href="#" class="linka5a5">n7100</a>
						</div>
					</div>
					...
					<div class="layout">
						<ul>
							...
							<li class="qwgo"><a href="#">趣味购</a>
								<div class="qwnav" style="padding: 20px;">
									<p>
										<strong>星座配件</strong>
